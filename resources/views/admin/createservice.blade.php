            ...
            <div class="container-card ">
                ...
                <form action="{{route('admin.servicestore')}}" method="POST">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" id="inputname" name="inputname" placeholder=" Ejemplo: Derecho Penal" required>
                        <label for="avatar">Imagen</label>
                        <input type="file" class="form-control" id="inputimagen" name="inputimagen" required>
                        <label for="inputdescripcion">Descripción</label>
                       
                        <textarea name="inputdescripcion" class="form-control" rows="10" cols="40" placeholder="Escribe aquí de que trata el servicio" required ></textarea>
                        <label for="inputdocumentacion">Documentación necesaria</label>
                        <textarea name="inputdocumentacion" class="form-control" rows="10" cols="40" placeholder="Escribe aquí los documentos necesarios" required></textarea>
