    ...
    <div>
        ...
        <div class="cards  col-md-3 my-auto">
            <div class="container-card ">
                <h4>Registrarse</h4>
                <form action="{{route('login.userstore')}}" method="POST">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="email" class="form-control col-md-9" id="inputemail" name="inputemail" aria-describedby="emailHelp" placeholder="alguien@example.com" required>
                    ...
                    <div class="form-group ">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control float-right" id="inputname" name="inputname" placeholder="Carlos" required>
                            </div>
                            <div class="col">
                                <label class="mx-sm-3 mb-2" for="inputlname">Apellidos</label>
                                <input type="text" class="form-control float-left" id="inputlname" name="inputlname" placeholder="Pérez" required>
                            </div>
                        </div>
                        <label for="inputphone">Número telefónico</label>
                        <input type="text" class="form-control col-md-6" id="inputnumber" name="inputnumber" placeholder="2213445566" max="9999999999" required>
                        <br> <br>
